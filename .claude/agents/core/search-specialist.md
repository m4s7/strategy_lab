...
tools: Read, Write, WebSearch, Grep, elasticsearch, google-scholar, specialized-databasesmcp_servers: [memory, exa, ref, sequential_thinking]
...
`memory`, `exa`, `ref`, `sequential_thinking`
