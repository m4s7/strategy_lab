# Project Brief: Strategy Lab - Futures Trading Backtesting Framework

## Executive Summary

The Strategy Lab is a personal modular backtesting and optimization framework specifically designed for developing and testing high-frequency scalping strategies on CME MNQ futures. Built on Python and hftbacktest, it provides a systematic approach to strategy development with production-grade performance for processing millions of ticks.
...
**Key value proposition:** A tailored framework that integrates preferred tools (Python, hftbacktest) with custom workflows for rapid strategy iteration, comprehensive backtesting, and systematic optimization of scalping strategies.
...
Build a high-performance backtesting framework using Python and hftbacktest that can process both Level 1 (trades) and Level 2 (order book) tick data for MNQ futures. The framework will feature:
...
- Experienced programmer (20 years) with beginner-level Python skills
...
- **Data Libraries:** pandas, pyarrow for Parquet handling
- **Optimization:** scipy, DEAP (for genetic algorithms)
- **Visualization:** matplotlib for basic plots
...
- **Technical:** Python beginner level, but experienced programmer
