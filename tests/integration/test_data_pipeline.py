...
class TestDataPipeline:
    ...
    def test_convert_l2_to_original_format(self):
        ...
        assert list(original.columns) == ['level', 'timestamp', 'mdt', 'price', 'volume', 'operation']
...
class TestIntegrationScenarios:
    ...
    def test_error_recovery_simulation(self):
        ...
        with patch('strategy_lab.data.adapters.hftbacktest.ParquetFileDiscovery') as mock_discovery_class:
            mock_discovery = MagicMock()
...
class TestPerformance:
    ...
    def test_large_dataset_processing(self):
        ...
        large_data = pd.DataFrame({
            ...
            'timestamp': range(1609459200000000000, 1609459200000000000 + n_records),
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            assert records_per_second > 1000  # Should process at least 1k records/second
            
            print(f"Processed {n_records} records in {processing_time:.2f}s "
